...
13. [[11_有限容量字节流|第 11 课：数据写得太快怎么办——有限容量字节流]] 已完成首次检查；主线正确，等待一次状态迁移复测后开放 TinyStream Lab。

> [!important]
> 第 11 课首次检查已完成，但状态迁移题需复测。第 9 课与 Lab 1 的到期复习继续保留在队列中；复测通过后开放 TinyStream Lab。
...
| 11 | [[11_有限容量字节流|有限容量字节流]] | 2.2–3 小时 | 基本掌握；等待状态迁移复测 |
