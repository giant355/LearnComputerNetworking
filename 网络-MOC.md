...
5. [[Labs/Lab0_TinyNet/README|Lesson 4 / Lab 0：TinyNet 数据报路由器]] 安排在 2026-09-02 中午回寝室后完成。
6. [[05_一次发送的完整旅程|第 5 课：把一次发送完整走通]] 已完成首次理论检查，目前为部分理解。
7. 先完成 [[05b_TTL与四种延迟补充|Lesson 5B：TTL 与四种延迟补充]]，再重新判断第 5 课掌握程度。

> [!important]
> 当前开放到 Lesson 5B。第 5 课的 Lab 部分与理论部分分开判断；目前只需修正 TTL 与延迟分类，不需要重读整课。
...
| 4A | [[04a_Lab0所需C++暖身|Lab 0 所需的 C++ 暖身]] | 0.5–0.8 小时 | 开放；等待检查 |
| 4 | [[Labs/Lab0_TinyNet/README|Lab 0：极小的 C++ 数据报网络]] | 2.5–4 小时 | 2026-09-02 中午实践 |
| 5 | [[05_一次发送的完整旅程|把一次发送完整走通：复盘与概念图谱]] | 1.5–2.25 小时 | 2026-09-02 首次检查：部分理解 |
| 5B | [[05b_TTL与四种延迟补充|TTL 与四种延迟补充]] | 10–20 分钟 | 首次复测部分理解；等待两道收尾题 |
