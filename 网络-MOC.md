...
8. [[06_网络前缀与最长前缀匹配|第 6 课]] 首次检查为部分掌握；现在完成 [[06b_补充_前缀范围与下一跳|Lesson 6B：前缀范围、下一跳与 ARP]]。

> [!important]
> 最长前缀匹配主干已经建立。先补齐 `/26` 范围、直连/网关下一跳和 ARP，再进入第 7 课。
...
| 顺序 | 内容 | 预计时间 | 状态 |
| --- | --- | ---: | --- |
| 6 | [[06_网络前缀与最长前缀匹配|网络前缀与最长前缀匹配]] | 1.75–2.5 小时 | 部分掌握；首次检查完成 |
| 6B | [[06b_补充_前缀范围与下一跳|前缀范围、下一跳与 ARP]] | 15–25 分钟 | 学习中；等待收尾复测 |
