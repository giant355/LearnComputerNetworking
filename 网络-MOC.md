...
11. [[09_网络接口状态机|第 9 课：把 ARP 变成状态机]] 已于 2026-09-08 完成检查站，达到基本掌握；现在开始 [[Labs/Lab1_TinyARPInterface/README|Lab 1：Tiny ARP Network Interface]]。

> [!important]
> 第 8 课已开放。已到期复习继续保留在队列中，不影响先阅读新课。
...
| 1 | [[Labs/Lab1_TinyARPInterface/README|Tiny ARP Network Interface]] | 1.5–2.5 小时（电脑旁） | 已开放；验证 ARP 缓存、待解析队列、帧接收与过期状态 |
