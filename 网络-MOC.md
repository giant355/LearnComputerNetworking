...
6. 课堂中可以提前阅读 [[05_一次发送的完整旅程|第 5 课：把一次发送完整走通]]；它不需要电脑，暂不算正式完成。

> [!important]
> 当前开放到第 5 课。第 5 课是为课堂场景提前开放的概念复盘，“看过”不会自动记为“掌握”；主线仍需完成第 4 课 Lab 0。
...
| 5 | [[05_一次发送的完整旅程|把一次发送完整走通：复盘与概念图谱]] | 1.5–2.25 小时 | 开放课堂预习；未检查 |
