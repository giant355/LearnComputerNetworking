...
12. [[10_端口与UDP|第 10 课：IP 找到电脑以后——端口、套接字与 UDP]] 已完成首次检查；主线正确，当前通过 [[10b_补充_UDP首部与封装长度|Lesson 10B]] 补齐 UDP 四字段与封装长度。

> [!important]
> 第 10 课当前为部分掌握。先完成 Lesson 10B 的三道迁移题，再进入有限容量字节流。
...
| 9 | [[09_网络接口状态机|把 ARP 变成状态机]] | 1.4–1.9 小时（课堂阅读） | 已开放；课堂检查站后做 Lab 1 |
...
| 顺序 | 内容 | 预计时间 | 状态 |
| --- | --- | ---: | --- |
| 10 | [[10_端口与UDP|端口、套接字与 UDP]] | 2–2.75 小时 | 部分掌握；主线正确，完成 10B 后收尾 |
| 10B | [[10b_补充_UDP首部与封装长度|UDP 首部与封装长度补充]] | 15–25 分钟 | 已开放；等待三道迁移题 |
