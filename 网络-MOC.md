...
5. [[Labs/Lab0_TinyNet/README|Lesson 4 / Lab 0：TinyNet 数据报路由器]] 已完成首次验收；公开测试通过，但需要修正下一跳来源并补全调试记录。
6. [[05_一次发送的完整旅程|第 5 课：把一次发送完整走通]] 的理论部分已基本掌握；Lab 0 单独待检。
7. [[05b_TTL与四种延迟补充|Lesson 5B：TTL 与四种延迟补充]] 的收尾复测已通过，首次复习为 2026-09-03。

> [!important]
> 第 5 课理论部分已经通过。Lab 0 当前为“部分理解、接近完成”：修正路由顺序测试暴露的问题后再进行最终验收。
...
| 4 | [[Labs/Lab0_TinyNet/README|Lab 0：极小的 C++ 数据报网络]] | 2.5–4 小时 | 首次验收：公开测试通过；额外测试失败；等待修正 |
